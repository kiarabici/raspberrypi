...
step3 = importlib.import_module("tml-solutions.testtest-58de.tml_read_MQTT_step_3_kafka_producetotopic_dag-testtest-58de")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_mqtt_dag-testtest-58de",
